...
values
('Built in 1915. It was formerly a treatment center for people with tuberculosis, many of whom passed away. Employees report hearing coughing in rooms.', 1),
('Built in the 19th century, the hotel is apparently haunted by its namesake, Charles Pfister, who likes to haunt MLB players staying in the hotel.', 2),
('Respondents described doors opening and closing, chandeliers shaking and objects falling to the floor. One witness reported a cold breeze that made her legs immobile. Another described the perfumed whiff of an unseen spirit brushing past her.', 3),
('Since Shaker’s opened in 1986, staff and customers alike have recounted stories of inexplicable occurrences and otherworldly sightings: Lights with fried bulbs turn on and off by themselves, doors close by unseen hands, and figures appear and disappear. Employees say they have all experienced something terrifying at the business, from pianos playing by themselves to objects flying off shelves. Researchers say the bar was built over a cemetery, which could explain some of the unsettling activity.', 4),
('It was bartender Matty Gonzales who saw the ghost in February 2010. While closing up, he had just taken out the trash and locked the doors. He saw a skinny old man in a suit with long gray hair standing inside the building. He wondered how the man had gotten in and was about to throw him out when the person moved toward him without moving his legs. The bartender grabbed his coat, set the alarm and left without closing his till for the night.', 5),
('Linda Mrochinski, operations manager, recounts the story of one tenant who was locking up for the night in Rosary Hall when she heard fabric swishing. Peering toward the Clare Wing, she saw a nun in full habit walking toward her. Noticeably absent were the sounds of footsteps. The sister passed through the doorway connecting Rosary and Loretto halls, but when the tenant followed, she found the doors, as they always were, still locked.', 6),
('The historic home was once owned by brothers Sam and Ed Pick – who worked for notorious gangster Al Capone. The property became a hub for gambling, illegal drinking, parties and prostitution. Some paranormal investigators believe that characters who worked at the mansion during the speakeasy era continue to roam the halls to this day.', 7),
('Legend has it that at least one male and one female entity call the theater home. Employees, artists and visitors have reported sightings, moving objects, the feeling of being watched while alone, and a strong scent of either perfume or cigar smoke.', 8),
('The Historic Miller Caves, which have a fascinating back story of their own, are supposedly haunted by the ghosts of two 19th century lovers who once used the caves for their secret meetings. A young man reportedly died after falling and hitting his head in a stairwell. Legend has it that his lover died weeks later, due to a broken heart.', 9),
...
('Volunteers say many people have heard the sound of kids laughing throughout the lighthouse, while getting the feeling that they are not alone or welcome.', 11),
('Milwaukee Public Museum is haunted by its former director, Dr. Stephan Francis Borhegyi (1921–1969). Doctor Borhegyi, who died in a car crash in 1969, has been known to spend time on the third floor of the building near his official portrait.', 12),
('The Rave started out as the home of the fraternal order of the Eagles (hence “Eagles Ballroom”) when it was built in 1927. It included a gymnasium, bowling alley, and swimming pool in the basement. Rumor is that it is haunted by various people: children who drowned in the pool, an abusive director of the shelter that was once housed here, and even Buddy Holly, who played one of his last concerts here. Touring bands often request tours of the basement and swimming pool area... or just find their way down there themselves.', 13),
