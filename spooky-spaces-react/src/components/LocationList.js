...
function LocationList( { user }){
  ...
  return(
    ...
    {location.encounters.map(en => <Encounter key={en.encounterId} encounterId={en.encounterId}
     description={en.description} encounterType={en.encounterType} deleteEncounter={deleteEncounters} />)}
    </div>   
  );
}
